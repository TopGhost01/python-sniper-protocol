...
# nexus_phase1_rep3_count_missions.py
# NEXUS Systems — Phase 1
# Counts confirmed active operations matching a given status
# Rep 3 proved the function stays pure. Math lives at the print call. The instrument never gets corrupted.
...
def count_missions(missions,status):
    ...
    return count
print(count_missions([{"name": "Ghost Protocol", "status": "Active"}],"Active") * 365)
