...
# Description: archive_transmission with try except — error handling Block 2
# What this rep proved: try except retyped from memory. Success and failure paths held clean. return None inside except. print and return clean_signal outside block. 
...
def archive_transmission(filename,raw_signal):
    ...
    print(clean_signal)  
    return clean_signal
archive_transmission("nexus_archive.txt", " DISPATCH_7 | NOMINAL | PRIORITY 1 ")   
