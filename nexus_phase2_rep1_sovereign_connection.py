...
# File: nexus_phase2_rep1_sovereign_connection.py
# Phase: 2
# Description: Sovereign connection to Microsoft Foundry
# What this rep proved: DefaultAzureCredential authentication live against Microsoft Foundry. SIGNAL_OPERATIVE_01 online.
